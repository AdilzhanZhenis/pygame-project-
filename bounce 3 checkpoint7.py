...
map = [
    ...
    "b                              bbbbbbbbbbbb    bbbbbb      fbb     bbbbbb b  1            bbbb",
    "b                          r                   bbbbbbb     fbb     bh     bbbbb           bbbb",
    "b      p    h                                  bbbbbbbb    fbbb    b      bbbbb           bbbb",
    "d     ebbffbb         f   e   e   2      1  e   hbbbbbb    fbbb  12b     bb               bbbb",
    "bbbbbbbbbbbbb      bbbbbbbbbbbbbbbb    bbbbbbbbbbbbbbb e     r   bbb    fbb              gbbbb",
    "bbbbbbbbbbbbb2     bbbbbbbbbbbbbbb    bbbbbbbbbbbbbbbbbbbbbbbbbbbbbb   fbbb        b     rbbbb",
    "b      bbbbbbbb    bbbbb           bbb                                             b     hbbbb",
    "b  b     bbbbbbb   bbbbb           bbbb                                           bbbbbbbbbbbb",                                                                                                                                    
    "b  bb1    bbbbbb     bbb        bbbbbbbbbbb h ffbbbb         1   e    e  2                bbbb", 
    "b  bbbbb          bb           h bbbbbbbbbbbbbbbbbbbbbb     bbbbbbbbgbbbbb               1bbbb",
    "b     bbbbbbbbbbbbb     bffffbb       bbb                     bbbb             bbbb    bbbbbbb",
    "b               bbbbbbbbbbbbbbbb      bbb                     bbbbh  bbbbbbbbbbbbbb    bbbbbbb",
    "bf     h r e  2       r          2 e  bbbr      bbbbb         bbbbbbbbbbbbbbbbbbbbbr hhbbbbbbb",
...
for i in range(len(map)):
    for j in range(len(map[i])):
        if map[i][j] == "d":
            doors.append(door(j * block_size, i * block_size))
...
def game_pause():
    ...
    while intro:
        ...
        screen.fill(white)
        screen.blit(intro_background, [0, 0])
        if button("Resume",100,430,280,85,white,'play'): #if button2(pause_photo,1300,20,1.5*block_size,1.5*block_size,'play'):
            start = True
            pause = False
